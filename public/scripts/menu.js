...
asideMenu.innerHTML = `
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard" target="_blank">
            <img src="../assets/img/PERA.svg" class="navbar-brand-img h-100" alt="main_logo">
            <span class="ms-1 font-weight-bold text-white">Pera Music</span>
        </a>
    </div>
...
divMenu.className = "collapse navbar-collapse  w-auto";
